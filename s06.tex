...
Najbliższa demonica, Obudzona, dostała gumowym butem prosto w zadek i nawet nie poczuła tego subtelnego ataku.
...
Postanowił więc wykonać swoją powinność w tradycyjny sposób, zamachnął się i wbił miecz w najbliższego neofantasorowego sługę, że ten aż odskoczył z bólu. 
...
Lecz to nie był koniec kontrataku, spadający błąd ortograficzny prawie rozciął bohatera na pół, Antyrax zdążył wykonać unik, lecz przez przypadek puścił szklaną broń. 
...
Wszyscy goście powinni przywiązywać niezwykłą wagę do szczegółów swojego wyglądu.
...
Lenna popatrzyła na Antyraxa i pokiwała w aprobacie głową.
...
Profesor niepostrzeżenie przemknął pod wodą przez Cieśninę Gibraltarską, potem statek wynurzył się z Morza Śródziemnego, 
...
\ds{} Niech mu będzie. \dm{} Winkla westchnęła, wyciągając strzykawkę z antidotum. Wyciąg z prac pierwszoklasistów. \dm{} Ale czekamy na prawdziwą walkę, w której naprawdę mogą przegrać.
\end{dialogue}
...
Mechaniczny się chichrał, Magda-niemowa wymachiwała rękoma, jak zepsuty wiatrak z obluzowanymi skrzydłami. Michał wyłączył niewidzialność na pasie, jego wyraz twarzy głosił ,,a nie mówiłem?''
...
Poruszałem się dalej, trafiłem na ścianę. Znowu. Jak to możliwe?
...
Przyjrzałem się bliżej tej rasie północnych.
...
Wszyscy twierdzą, że przesadzam z tymi testami, ale uważam że jak ktoś potrafi przeżyć ideologiczne piekło, to poradzi sobie potem ze wszystkim.
...
Gdy ludzie się najedli, ściana się otwarła, odsłaniając sporą salę z rzędami concatesów.
...
W czasie jedzenia nie było komunikatu, za to później ściana po drugiej stronie naszej sypialni otwarła się i silne światło słoneczne oślepiło nas.
...
Skopiowałem sobie wszystkie te jego dzieła na własne urządzenie i odłożyłem niemoją własność z powrotem, tak, jak była.
...
Wieczorem musiałem nadgonić zurdowskiego.
...
\begin{dialogue}
\ds{} \differentlan{A teraz zabawimy się} \dm{} powiedziała donośnym głosem. Nic nie zrozumiałem.
\end{dialogue}
...
\begin{dialogue}
\ds{} \differentlan{Co powiecie na to?} \dm{} Uderzył pięścią z całej siły w środek kompleksu. 
...
\ds{} \differentlan{Wypierdalaj z mojego opowiadania!} \dm{} Mój kolega odkrzyknął. Nie wiedziałem, że zna język tego giganta. \dm{} 
\differentlan{Zabijasz niewinnych, oni mają wyprane mózgi, dlatego cię atakują!}
\ds{} \differentlan{Jaka szkoda.} \dm{} Przejechał ręką po głównym murze, zwalając wszystkie reflektory. 
\end{dialogue}
...
Wtem błyskawice zgasły, a mój nizjen zasygnalizował uszkodzenie modułu hipera.
...
Jak tylko ponownie przekroczyłem atmosferę, znowu wystrzeliły w nas rakiety.
...
\begin{dialogue}
\ds{} \differentlan{Hos, ja Rohost. Pokój} \dm{} krzyczałem z całych sił po zurdowsku.
...
\begin{dialogue}
\ds{} \differentlan{Rohost? Co ty robisz w statku Czarnych? Nie wiem, po co wróciłeś, ale nie pozwolę ci skrzywdzić Profesora.} \dm{} Głos Hosa rozległ się jak przez megafon.
\ds{} \differentlan{Kogo?} \dm{} Chyba się przesłyszałem. Albo nie zrozumiałem zurdowskiego.
\end{dialogue}
...
\begin{dialogue}
\ds{} \differentlan{Panie Dernasztapie, jak miło znów pana widzieć. Ziemskie przysmaki już na pana czekają.} \dm{} Profesor Kula przywitał się z Hosem, w perfekcyjnym zurdowskim. \dm{} 
\differentlan{O, i jest także Mateusz. Cóż za niespodzianka.}
\ds{} \differentlan{Chwila, Profesor go zna?} \dm{} Hos dopiero teraz obniżył działko hipera.
\ds{} \differentlan{Oczywiście, to nowy kandydat na członka ALOPP. Mieliśmy przyjemność zjeść razem bankiet nie tak dawno temu} \dm{} 
...
\ds{} Dalej, pochwal się co pięknego narobiłeś. \dm{} Usłyszał lądującego za sobą Plazmę. \dm{} \differentlan{Rohost chciał ratunek Hos, ale atak Plazma.}
\end{dialogue}
...
\ds{} \differentlan{On nie wie.} \dm{} Kula użył zurdowskiego.
\ds{} \differentlan{Nikt nie wie.} \dm{} Tajemniczo rozłożył ręce Dernasztap.
...
Świecąca strużka energii wychodziła z mojej klatki i niknęła w suficie, w miejscu gdzie przebywał kilka pięter wyżej Plazma.
