...
Czułem się dumny, że będę brał udział w jego odzyskaniu.
...
Jednak program był on póki co bardzo prosty, znajdował tylko błędy, które Antyrax popełnił wcześniej.
...
Każdy concates miał odpowiedni symbol na futusi, miał przydzieloną bulię z zestawem wszystkich potrzebnych urządzeń.
...
Nie mogłem się doczekać następnego dnia, nie sądzę, żebyśmy otrzymali hipery, ale kto wie.
...
\begin{dialogue}
\ds{} Pokażcie się, bo dokończę ten zboczony fragment! \dm{} Antyrax zawołał. Nikt mu jednak nie odpowiedział. \dm{} Dodam do tego transformacje płci, korki analne i sadystyczne tortury.
...
Antyrax wziął się za opowiadanie.
