...
Skąd ty tak właściwie masz daser? To zbyt cenna technologia, żeby instalować ją w śmieciach. Pomyśl, co by się stało, gdyby ta srebrna ciesz ją przejęła.
...
\ds{} Już mówiłem. To test charakteru, masz się zachować, a nie walczyć. Walczyć umiesz świetnie.
\end{dialogue}
...
Z piasku wyskakiwały na nas co chwila robotyczne technogony, ale ja byłem za szybki, żeby dać się złapać.
Jednego takiego robaka przebiłem na pół, olej i kółka zębate splamiły piasek.
...
Szklany taras był kiedyś apartamentem jakiegoś bogacza. W pustym basenie leżały resztki samicznych strojów kąpielowych.
...
Ani żywej duszy. Usłyszałem w oddali tupot, podskoczyłem do najbliższego okna i schowaliśmy się w jakimś mieszkaniu.
...
Poleciłem Mateuszowi zostać, sam skoczyłem na nich.
...
Z tego się dowiedziałem, rzeczywiście Komodowa Armia miała wykonać szturm na swoje byłe miasto, do którego przeprowadzili się imigranci z północy, ich wrogowie.
...
Podziękowałem mojemu informatorowi, wróciłem do mojego człowieka i polecieliśmy pod osłoną nocy do najbliższej wioski pod władaniem Komodowców na pustyni.
Mateusz zapytał mnie, dlaczego zabiłem niewinne osoby.
Opowiedziałem mu, jacy ludzie są wcielani do Czarnej Armii, jak smar khaki zmienia działanie organizmu, do której wnika.
Najgorszy sort obywateli jest zakuwany z mechaniczne zbroje, a potem zalewany odżywczym i bakteriobójczym środkiem, zwanym smarem khaki.
Stają się morderczymi maszynami, uzależnionymi od kleistej mazi. Maź jest uzupełniana częściej tym żołnierzom, którzy wykazali się większym okrucieństwem.
...
Odebrano im całą elektronikę, bez gogli rozszerzonej rzeczywistości nie umieli się zająć niczym innym, niż grą w głupie gierki, a zwłaszcza rozmową.
...
Wszyscy mówią, że przesadzam z tymi testami, ale uważam że jak ktoś potrafi przeżyć ideologiczne piekło, to poradzi sobie potem ze wszystkim.
...
Do czego jest skłonny, tego w ciągu miesiąca się dowiem.
...
Był ciemniejszy niż ja, bardziej pomarańczowy, musiał mieć jakiś defekt genetyczny.
Widać teraz biorą do armii kogo popadnie.

Wrota się zasunęły i klimatyzator począł czyścić powietrze ze stęchlizny. Niewiele to oczywiście dało.
...
Zimna para ochlapała mnie, potem jakiś śmierdzący detergent, na koniec ponownie woda.
...
Straciłem także większość dulicy, ale przecież odrosną.
...
Był w kolejności dość daleko od mojego, nie poprawiło mi to humoru.
...
Jednak program był póki co bardzo prosty, znajdował tylko pomieszane słowa, które Antyrax popełnił wcześniej.
...
Tutaj już nie było regeli, ale przecież byliśmy w wojsku, trzeba ćwiczyć na każdym krokiem, to zrozumiałe.
...
Nie mogłem się doczekać następnego dnia, nie sądzę, żebyśmy już juro otrzymali nasze zbroje, ale kto wie.
